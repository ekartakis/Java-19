...
public class StudentOnlyLight extends JFrame {
	...
	public StudentOnlyLight() {
		...
		JLabel lblNewLabel = new JLabel("You should stay in quarantine for 10 days from " + StudentCloseCon.dateclosecont);
		lblNewLabel.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
		lblNewLabel.setBounds(27, 44, 944, 50);
		...
		btnBackButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				CollStudentMenu studmenu = new CollStudentMenu();
