...
public class MainMenu extends JFrame {
  ...
  */
  ...
  public MainMenu() {
    ...
    //Creating and displaying the College Student button.
    //The College Student button calls the CollegeStudentLogin class.
    ...
    //Create and display the General Staff button.
    //The General Staff button calls the GeneralStaffLogin class.
    ...
    //Creating and displaying the University Administration button.
    /*The University Administration button calls
     *  the UniversityAdministrationLogin class.*/
    JButton btnUniversityAdministrationButton = new JButton(
        "University Administration");
    btnUniversityAdministrationButton.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        UniversityAdministrationLogin universityadministrationlogin = 
            new UniversityAdministrationLogin();
        universityadministrationlogin.setVisible(true);
        setVisible(false);
      }
    });
    btnUniversityAdministrationButton.setFont(new Font(
