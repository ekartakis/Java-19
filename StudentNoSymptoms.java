 ...
 * Create the frame.
 */
  //In this case the student is a close contact but has no symptoms.
  public StudentNoSymptoms() {
    ...
    JLabel lblNewLabel = new JLabel("Stay in quarantine for "
        + "7 days from " + StudentCloseCon.dateclosecont);
    ...
    Image img10 = new ImageIcon(this.getClass().getResource("/Pics/135464593_1"
        + "077636602678989_8400056473973577538_n.png")).getImage();
