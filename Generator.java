...
public class Generator {
	...
	public static void dataBase() {
		...
		for(int i=1 ; i<= 1250; i++) {
			...
			System.out.println("INSERT INTO STUDENT (AM,name,surname,status,closecontact)\nValues ('"+ AM + "', '" + namesmen[randname] + "', '"+ surnamemen[randsurname] + "','n','false');" );
			AM++;
			System.out.println("INSERT INTO STUDENT (AM,name,surname,status,closecontact)\nValues ('"+ AM + "', '" + nameswomen[randname] + "', '"+ surnamewomen[randsurname] + "','n','false');" );
			AM++;
		}
