...
public class AnotherStCloseCont extends JFrame {
  ...
  * Create the frame.
  */
  /*The university administration adds another student
  ...
  public AnotherStCloseCont() {
    ...
    JLabel lblAddAnotherStudentCloseContact = new JLabel(
        "Would you like to add another close contact?");
    lblAddAnotherStudentCloseContact.setFont(new Font(
    ...
    //The Yes button goes to the new positive student case menu.
