...
public class AnotherStaffMemberCloseCont extends JFrame {
	...
	public AnotherStaffMemberCloseCont() {
		...
		JLabel lblAddAnotherStaffMemberCloseContact = new JLabel("Would you like to add another close contact?");
		lblAddAnotherStaffMemberCloseContact.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
