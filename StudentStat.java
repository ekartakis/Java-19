  ...
  */
  public StudentStat() {
    ...
    JLabel lblNewLabel_1 = new JLabel(
        "Total positive cases: " + total_cases + " ( " + percent1 + "% )");
    ...
    JLabel lblNewLabel_2 = new JLabel(
        "Student positive cases : " + student_cases + " ( " + percent2 + "% )");
    ...
    JLabel lblNewLabel_3 = new JLabel(
        "Staff positive cases : " + staff_cases + " ( " + percent3 + "% )");
    ...
    lblNewLabel_4.setBounds(629, 251, 533, 41);
    contentPane.add(lblNewLabel_4);

    int student_close_contacts =
