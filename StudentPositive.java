...
public class StudentPositive extends JFrame {
	...
	public StudentPositive() {
		...
		JLabel lblNewLabel_2 = new JLabel("- Do not leave your home for any reason \u2013 \t");
		...
		Image img11 = new ImageIcon(this.getClass().getResource("/Pics/stay-home.png")).getImage();
		...
		JLabel lblNewLabel_10 = new JLabel("   if you need food or medicine, order it online or by phone,");
		...
		Image img14 = new ImageIcon(this.getClass().getResource("/Pics/stay-home.png")).getImage();
