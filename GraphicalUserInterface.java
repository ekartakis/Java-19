...
public class GraphicalUserInterface {
  ...
  */
  private void initialize() {
    ...
    //Creating and displaying the Start button.
    //The Start button calls the MainMenu class.
    ...
    Image img6 = new ImageIcon(this.getClass().getResource(
        "/Pics/viruss.png")).getImage();
