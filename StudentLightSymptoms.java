...
public class StudentLightSymptoms extends JFrame {
	...
	public StudentLightSymptoms() {
		...
		lblNewLabel_2.setBounds(12, 126, 178, 35);
		...
		lblNewLabel_5.setBounds(12, 264, 158, 35);
		...
		lblNewLabel_9.setBounds(12, 448, 168, 35);
		...
		Image img12 = new ImageIcon(this.getClass().getResource("/Pics/headache.png")).getImage();
		...
		Image img11 = new ImageIcon(this.getClass().getResource("/Pics/vomiting.png")).getImage();
		...
		Image img13 = new ImageIcon(this.getClass().getResource("/Pics/cold.png")).getImage();
		lblImage13.setIcon(new ImageIcon(img13));
		lblImage13.setBounds(200, 143, 64, 64);
		contentPane.add(lblImage13);
		Image img14 = new ImageIcon(this.getClass().getResource("/Pics/cold.png")).getImage();
		
		JLabel lblImage16 = new JLabel("");
		Image img16 = new ImageIcon(this.getClass().getResource("/Pics/fatigue.png")).getImage();
		...
		Image img17 = new ImageIcon(this.getClass().getResource("/Pics/diarrhea.png")).getImage();
		...
		Image img8 = new ImageIcon(this.getClass().getResource("/Pics/diarrhea (1).png")).getImage();
