...
public class StaffStat extends JFrame {
  ...
  * Create the frame.
  */
  //This is the statistics that the staff member can watch.
  public StaffStat() {
    ...
    JLabel lblNewLabel1 = new JLabel("Total positive cases: " 
        + totalcases + " ( " + percent1 + "% )");
    ...
    JLabel lblNewLabel2 = new JLabel("Student positive cases : " 
        + studentcases + " ( " + percent2 + "% )");
    lblNewLabel2.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
    lblNewLabel2.setBounds(87, 314, 533, 41);
    ...
    JLabel lblNewLabel3 = new JLabel("Staff positive cases : " 
        + staffcases + " ( " + percent3 + "% )" );
    lblNewLabel3.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
    lblNewLabel3.setBounds(87, 372, 533, 41);
