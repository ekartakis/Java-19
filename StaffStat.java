...
public class StaffStat extends JFrame {
  ...
  */
  public StaffStat() {
    ...
    JLabel lblNewLabel_1 = new JLabel("Total positive cases: " 
        + total_cases + " ( " + percent1 + "% )");
    ...
    JLabel lblNewLabel_2 = new JLabel("Student positive cases : " 
        + student_cases + " ( " + percent2 + "% )");
    ...
    JLabel lblNewLabel_3 = new JLabel("Staff positive cases : " 
        + staff_cases + " ( " + percent3 + "% )" );
    ...
    JLabel lblNewLabel_4 = new JLabel("Total close contacts : " 
        + total_close_contacts + " ( " + percent4 + "% )");
    lblNewLabel_4.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
    lblNewLabel_4.setBounds(630, 251, 533, 41);
    contentPane.add(lblNewLabel_4);
		
    int student_close_contacts = UpdateTheRecords.
    ...
    JLabel lblNewLabel_5 = new JLabel("Close contacts (students): " 
        + student_close_contacts + " ( " + percent5 + "% )");
    ...
    JLabel lblNewLabel_6 = new JLabel("Close contacts (staff): " + 
        staff_close_contacts + " ( " + percent6 + "% )");
