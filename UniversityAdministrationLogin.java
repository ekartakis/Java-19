...
public class UniversityAdministrationLogin extends JFrame {
	...
	public UniversityAdministrationLogin() {
		...
		lblUniversityAdministrationLogin.setFont(new Font("Bookman Old Style", Font.PLAIN, 30));
		...
		Image img4 = new ImageIcon(this.getClass().getResource("/Pics/close (1).png")).getImage();
