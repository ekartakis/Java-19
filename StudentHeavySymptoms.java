 ...
 * Create the frame.
 */
  //In this case the staff member has heavy symptoms.
  public StudentHeavySymptoms() {
    ...
    JLabel lblNewLabel = new JLabel("You should stay in Quarantine "
        + "for 14 days from " + StudentCloseCon.dateclosecont);
    lblNewLabel.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
    lblNewLabel.setBounds(12, 53, 826, 55);
    ...
    lblNewLabel1.setBounds(12, 119, 428, 55);
    ...
    Image img10 = new ImageIcon(this.getClass().getResource("/Pics"
        + "/135464593_1077636602678989_8400056473973577538"
        + "_n.png")).getImage();
