...
public class StaffPositive extends JFrame {
  ...
  */
  public StaffPositive() {
    ...
    JLabel lblNewLabel_4 = new JLabel("- Try to avoid contact with anyone you "
    ...
    JLabel lblNewLabel_5 = new JLabel("- People you live with do not "
    ...
    JLabel lblNewLabel_6 = new JLabel("- People in your support bubble do not "
    		+ "need to self-isolate if you do not have symptoms.");
    lblNewLabel_6.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
    lblNewLabel_6.setBounds(12, 393, 1194, 32);
    contentPane.add(lblNewLabel_6);
		
    JLabel lblNewLabel_7 = new JLabel("WARNING: If you live with someone at "
    ...
    JLabel lblNewLabel_8 = new JLabel(" try to arrange for them to stay with "
    ...
    JLabel lblNewLabel_9 = new JLabel("   or ask friends and family to drop it "
    		+ "off at your home.");
    lblNewLabel_9.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
    lblNewLabel_9.setBounds(12, 221, 775, 32);
    contentPane.add(lblNewLabel_9);
		
    JLabel lblNewLabel_10 = new JLabel("   if you need food or medicine, order "
