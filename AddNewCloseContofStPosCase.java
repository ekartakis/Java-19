...
public class AddNewCloseContofStPosCase extends JFrame {
	...
	public AddNewCloseContofStPosCase() {
		...
		JLabel lblInsertIDofclosecontact = new JLabel("Please insert the academic id of the close contact:");
		lblInsertIDofclosecontact.setFont(new Font("Bookman Old Style", Font.PLAIN, 27));
