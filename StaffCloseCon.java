...
public class StaffCloseCon extends JFrame {
	...
	public StaffCloseCon() {
		...
		Image img11 = new ImageIcon(this.getClass().getResource("/Pics/fever (1).png")).getImage();
		...
		Image img13 = new ImageIcon(this.getClass().getResource("/Pics/breathing (2).png")).getImage();
		...
		Image img9 = new ImageIcon(this.getClass().getResource("/Pics/cough.png")).getImage();
		...
		Image img20 = new ImageIcon(this.getClass().getResource("/Pics/dizziness.png")).getImage();
		...
		Image img14 = new ImageIcon(this.getClass().getResource("/Pics/loss-of-sense-of-taste.png")).getImage();
