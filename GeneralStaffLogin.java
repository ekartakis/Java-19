...
public class GeneralStaffLogin extends JFrame {
  ...
  * Create the frame.
  */
  //The staff member logs in his/her profile.
  public GeneralStaffLogin() {
    ...
    //This is where he/she writes his/her TIN.
    ...
    btnGeneralStaffLogin.addActionListener(new ActionListener() {
      /*Checking if the TIN is correct and updates the database in case it is.
       ...
       Then the Login button calls the GeneralStaffMenu class. 
        If the TIN is incorrect, a message is displayed in the screen
        to warn the user.*/
