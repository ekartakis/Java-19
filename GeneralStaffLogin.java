...
public class GeneralStaffLogin extends JFrame {
	...
	private JPasswordField passwordCollStuLogin;
	...
	public GeneralStaffLogin() {
		...
		passwordCollStuLogin = new JPasswordField();
		passwordCollStuLogin.setBounds(221, 192, 488, 53);
		contentPane.add(passwordCollStuLogin);
	}
}